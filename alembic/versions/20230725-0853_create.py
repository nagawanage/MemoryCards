...
Revision ID: eac79f3079f3
Revises: 
Create Date: 2023-07-25 08:53:00.633858
...
def upgrade() -> None:
    ...
    sa.Column('user_id', sa.String(length=32), nullable=False, comment='ユーザーID'),
    sa.Column('name', sa.String(length=255), nullable=False, comment='単語名'),
    ...
    sa.Column('id', sa.String(length=32), nullable=False),
    sa.Column('user_id', sa.String(length=32), nullable=False, comment='ユーザーID'),
    sa.Column('name', sa.String(length=255), nullable=False, comment='単語帳グループ名'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('miss_count', sa.Integer(), server_default='0', nullable=False, comment='間違えた回数'),
    sa.Column('check1_updated_at', sa.TIMESTAMP(), nullable=True, comment='チェックマーク1更新日時'),
    sa.Column('check2_updated_at', sa.TIMESTAMP(), nullable=True, comment='チェックマーク2更新日時'),
    sa.Column('check3_updated_at', sa.TIMESTAMP(), nullable=True, comment='チェックマーク3更新日時'),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.Column('deleted_at', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('id')
